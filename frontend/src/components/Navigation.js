...
import { Home, Users, FileText, BarChart3, Settings, ListOrdered, Monitor, Camera, MessageSquare } from "lucide-react";
...
export default function Navigation() {
  ...
  const navItems = [
    ...
    { path: "/review-tracker", label: "Reviews", icon: MessageSquare },
