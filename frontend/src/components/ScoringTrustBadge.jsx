  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent
          className="max-w-2xl bg-slate-900 border-slate-700 text-slate-100 max-h-[92vh] flex flex-col p-0 gap-0"
          data-testid="scoring-trust-modal"
        >
          <DialogHeader className="p-4 sm:p-6 pb-2 sm:pb-3 border-b border-slate-800 shrink-0">
          ...
          <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-4" data-testid="scoring-trust-body">
            {issues.length > 0 && (
          ...
          <DialogFooter className="flex-col sm:flex-row gap-2 px-4 sm:px-6 py-3 border-t border-slate-800 bg-slate-900 shrink-0">
            <button
              type="button"
