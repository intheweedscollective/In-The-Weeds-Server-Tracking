...
const HELP_TOPICS = {
  ...
  "rt-bonus": {
    ...
    content: "Each positive mention on external reviews earns RT bonus points. Q2+ rule: 0.33 pts per mention, capped at 20 pts. Older quarters (Q1) used 0.5 pts/mention with a 15 pt cap.",
    link: "/help#scoring-formula",
