...
export default function Analytics() {
  ...
  const handlePrint = async () => {
    try {
      ...
      if (isIOS) {
        window.open(`${BACKEND_URL}/api/v2/analytics/${selectedYear}/${selectedQuarter}/pdf`, "_blank", "noopener,noreferrer");
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-4 mb-8 p-4 bg-background rounded-lg">
          ...
          <select
            ...
            className="px-3 py-2 border border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-700 text-slate-200"
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bubba-card">
                <div className="p-5">
                  ...
                  <img 
                    src={`${BACKEND_URL}/api/v2/trends/${selectedYear}/${selectedQuarter}/team?chart_type=comparison`}
              ...
              <div className="bubba-card">
                <div className="p-5">
                  ...
                  <img 
                    src={`${BACKEND_URL}/api/v2/trends/${selectedYear}/${selectedQuarter}/team?chart_type=distribution`}
