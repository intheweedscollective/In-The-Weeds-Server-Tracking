...
def score_with_direct_injection(
    ...
    for e in staged_emps:
        ev2 = EmployeeV2(
            ...
            cv_promoters=int(_fnum(e.get("cv_promoters"))),
            cv_passives=int(_fnum(e.get("cv_passives"))),
            cv_detractors=int(_fnum(e.get("cv_detractors"))),
            cv_score=0.0,  # let calculate_customer_voice_score compute
